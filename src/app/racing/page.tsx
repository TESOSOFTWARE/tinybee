    ...
    <div className="min-h-screen bg-playful-dots py-4 px-4 flex flex-col justify-between select-none">
      ...
      <header className="max-w-4xl w-full mx-auto flex items-center justify-between mb-2">
        ...
        <div className="text-center">
          ...
          <h2 className="text-base font-black text-slate-800 flex items-center gap-1 justify-center">
            🏎️ Pet Racing Academy (Level {levelId})
          </h2>
        </div>

        {/* Combo flame */}
        <div className="flex items-center gap-1.5 bg-yellow-100 border-2 border-yellow-300 text-yellow-800 px-3.5 py-1 rounded-full font-black text-xs shadow-sm">
          <Flame className={`w-4 h-4 ${combo > 0 ? 'text-orange-500 fill-orange-400 animate-pulse' : 'text-yellow-400'}`} />
          Streak: {combo}
        </div>
      </header>
      ...
      <footer className="max-w-4xl w-full mx-auto flex flex-col gap-3 mt-3">
        <Card variant="scroll" padding="md" className="flex flex-col gap-4 shadow-md bg-[#fdf6e2]">
          ...
          <div className="text-center py-1">
            <p className="text-sm font-bold text-amber-800 uppercase tracking-widest">CAST ACCEL CHARM</p>
