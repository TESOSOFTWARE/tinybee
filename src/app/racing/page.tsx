    ...
    <div className="min-h-screen bg-playful-dots py-2 sm:py-4 px-2 sm:px-4 flex flex-col justify-between select-none">
      ...
      <header className="max-w-4xl w-full mx-auto flex items-center justify-between mb-1.5 sm:mb-2">
        ...
        <div className="flex items-center gap-2 select-none">
          ...
          {/* Combo flame */}
          <div className="flex items-center gap-1 sm:gap-1.5 bg-yellow-100 border-2 border-yellow-300 text-yellow-800 px-2 py-0.5 sm:px-3.5 sm:py-1 rounded-full font-black text-[10px] sm:text-xs shadow-sm h-7 sm:h-8">
