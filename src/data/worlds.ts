...
export const STATIC_WORLDS_DATABASE: { [id: string]: WorldConfig } = {
  ...
  'g12-integrals': {
    ...
    nodeColor: 'yellow',
    emoji: '🏛️',
    monsterNames: ['Area Slime', 'Obelisk Sprite', 'Sum Golem', 'Curve Wyvern', 'Leibniz Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'bramble_golem', 'sparky_dragon', 'sparky_dragon']
  },
  // ==================== ENGLISH WORLDS ====================
  ...
  'gk-colors-shapes': {
    ...
    nodeColor: 'blue',
    emoji: '🔴',
    monsterNames: ['Alphabet Slime', 'Letter Imp', 'Meadow Pixie', 'A-B-C Bunny', 'Word Drake Boss'],
  ...
  'gk-family-pets': {
    ...
    nodeColor: 'green',
    emoji: '🐶',
    monsterNames: ['Sight Slime', 'Visual Imp', 'Flash Sprite', 'Garden Golem', 'Insight Dragon Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'bramble_golem', 'sparky_dragon'],
    subject: 'english',
    badge: 'Family & Pets 🐶',
  ...
  'gk-fruit-veggies': {
    ...
    nodeColor: 'orange',
    emoji: '🍎',
    monsterNames: ['Sound Slime', 'Echo Sprite', 'Vowel Pixie', 'Sonic Golem', 'Chorus Griffin Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'bramble_golem', 'sparky_dragon'],
    subject: 'english',
    badge: 'Fruit & Veggies 🍎',
  ...
  'gk-toys-games': {
    ...
    nodeColor: 'purple',
    emoji: '🧸',
    monsterNames: ['Comprehension Slime', 'Plot Imp', 'Detail Knight', 'Summary Wyvern', 'Story King Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'sparky_dragon', 'sparky_dragon', 'sparky_dragon'],
    subject: 'english',
    badge: 'Toys & Games 🧸',
  ...
  'gk-body-parts': {
    ...
    nodeColor: 'yellow',
    emoji: '👃',
    monsterNames: ['Noun Slime', 'Verb Imp', 'Synonym Sprite', 'Word Golem', 'Lexicon Druid Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'bramble_golem', 'bramble_golem'],
    subject: 'english',
    badge: 'Body Parts 👃',
  ...
  'g1-home-furniture': {
    ...
    nodeColor: 'blue',
    emoji: '🏠',
    monsterNames: ['Letter Slime', 'Vowel Golem', 'Consonant Imp', 'Forest Dryad', 'Dictation Lord Boss'],
    monsterIds: ['muddy_slime', 'bramble_golem', 'muddy_slime', 'bramble_golem', 'bramble_golem'],
    subject: 'english',
  ...
  'g1-action-verbs': {
    ...
    nodeColor: 'purple',
    emoji: '🏃',
    monsterNames: ['Pronoun Slime', 'Tense Imp', 'Grammar Guard', 'Adjective Ogre', 'Sintax Sea Dragon Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'fluffy_ogre', 'sparky_dragon'],
    subject: 'english',
    badge: 'Action Verbs 🏃',
    bgStyle: 'bg-purple-50 border-purple-300 hover:border-purple-400',
  ...
  'g1-hygiene-grooming': {
    ...
    nodeColor: 'green',
    emoji: '🧼',
    monsterNames: ['Soap Slime', 'Suds Sprite', 'Bubble Imp', 'Brush Golem', 'Hygiene Hero Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'bramble_golem', 'sparky_dragon'],
    subject: 'english',
  ...
  'g1-playground-park': {
    ...
    nodeColor: 'orange',
    emoji: '🛝',
    monsterNames: ['Swing Slime', 'Slide Sprite', 'Sandbox Imp', 'Fountain Golem', 'Playground King Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'bramble_golem', 'sparky_dragon'],
    subject: 'english',
  ...
  'g1-insects-bugs': {
    ...
    nodeColor: 'yellow',
    emoji: '🐜',
    monsterNames: ['Larva Slime', 'Caterpillar Sprite', 'Wasp Imp', 'Hive Golem', 'Queen Bee Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'bramble_golem', 'sparky_dragon'],
    subject: 'english',
    badge: 'Insects & Bugs 🐜',
    bgStyle: 'bg-amber-50 border-amber-300 hover:border-amber-400',
  ...
  'g1-feelings-emotions': {
    ...
    nodeColor: 'purple',
    emoji: '😄',
    monsterNames: ['Moody Slime', 'Silly Sprite', 'Grumpy Imp', 'Gloomy Golem', 'Empathetic Dragon Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'bramble_golem', 'sparky_dragon'],
    subject: 'english',
  ...
  'g2-food-drinks': {
    ...
    nodeColor: 'green',
    emoji: '🍔',
    monsterNames: ['Clause Slime', 'Phrase Bat', 'Subject Gargoyle', 'Predicate Ogre', 'Sentence Sorcerer Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'fluffy_ogre', 'fluffy_ogre', 'fluffy_ogre'],
    subject: 'english',
    badge: 'Food & Drinks 🍔',
    bgStyle: 'bg-teal-50 border-teal-300 hover:border-teal-400',
    textStyle: 'text-teal-900',
  ...
  'g2-jobs-occupations': {
    ...
    nodeColor: 'blue',
    emoji: '🧑‍🚒',
    monsterNames: ['Apprentice Slime', 'Worker Sprite', 'Officer Imp', 'Builder Golem', 'Boss Director Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'bramble_golem', 'sparky_dragon'],
    subject: 'english',
  ...
  'g2-vehicles-travel': {
    ...
    nodeColor: 'green',
    emoji: '✈️',
    monsterNames: ['Scooter Slime', 'Driver Sprite', 'Pilot Imp', 'Engine Golem', 'Captain Dragon Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'bramble_golem', 'sparky_dragon'],
    subject: 'english',
  ...
  'g2-plants-nature': {
    ...
    nodeColor: 'green',
    emoji: '🌱',
    monsterNames: ['Sprout Slime', 'Seed Sprite', 'Flower Imp', 'Oak Golem', 'Forest Spirit Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'bramble_golem', 'sparky_dragon'],
    subject: 'english',
    badge: 'Plants & Nature 🌱',
  ...
  'g2-construction-materials': {
    ...
    nodeColor: 'orange',
    emoji: '🧱',
    monsterNames: ['Clay Slime', 'Brick Sprite', 'Iron Imp', 'Stone Golem', 'Steel Dragon Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'bramble_golem', 'sparky_dragon'],
    subject: 'english',
  ...
  'g2-clothing-accessories': {
    ...
    nodeColor: 'purple',
    emoji: '🧥',
    monsterNames: ['Thread Slime', 'Button Sprite', 'Zipper Imp', 'Armor Golem', 'Fashion Dragon Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'bramble_golem', 'sparky_dragon'],
    subject: 'english',
  ...
  'g3-sea-creatures': {
    ...
    nodeColor: 'blue',
    emoji: '🐙',
    monsterNames: ['Adverb Slime', 'Preposition Imp', 'Conjunction Sprite', 'Noun Ogre', 'Grammarian Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'fluffy_ogre', 'fluffy_ogre'],
    subject: 'english',
    badge: 'Sea Creatures 🐙',
    bgStyle: 'bg-indigo-50 border-indigo-300 hover:border-indigo-400',
  ...
  'g4-nature-landforms': {
    ...
    nodeColor: 'blue',
    emoji: '🏔️',
    monsterNames: ['Antonym Slime', 'Synonym Sprite', 'Homophone Imp', 'River Golem', 'Kraken Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'bramble_golem', 'sparky_dragon'],
    subject: 'english',
  ...
  'g4-cooking-utensils': {
    ...
    nodeColor: 'green',
    emoji: '🍳',
    monsterNames: ['Comma Slime', 'Apostrophe Imp', 'Hyphen Gargoyle', 'Colon Minotaur', 'Period Lord Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'fluffy_ogre', 'fluffy_ogre', 'fluffy_ogre'],
    subject: 'english',
  ...
  'g5-space-astronomy': {
    ...
    nodeColor: 'blue',
    emoji: '🚀',
    monsterNames: ['Simile Slime', 'Metaphor Sprite', 'Idiom Golem', 'Hyperbole Bandit', 'Oasis Sphinx Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'bramble_golem', 'fluffy_ogre', 'fluffy_ogre'],
    subject: 'english',
  ...
  'g5-animals-habitats': {
    ...
    nodeColor: 'green',
    emoji: '🌲',
    monsterNames: ['Root Slime', 'Prefix Sprite', 'Suffix Imp', 'Summit Wyvern', 'Etymology Titan Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'sparky_dragon', 'sparky_dragon'],
    subject: 'english',
  ...
  'g6-descriptive-adjectives': {
    ...
    nodeColor: 'blue',
    emoji: '🎨',
    monsterNames: ['Antecedent Slime', 'Case Imp', 'Agreement Sprite', 'Ruin Golem', 'Pronoun King Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'bramble_golem', 'bramble_golem'],
    subject: 'english',
    badge: 'Adjectives 🎨',
    bgStyle: 'bg-indigo-50 border-indigo-300 hover:border-indigo-400',
  ...
  'g6-science-lab': {
    ...
    nodeColor: 'green',
    emoji: '🧪',
    monsterNames: ['Relation Slime', 'Logic Imp', 'Ratio Sprite', 'Swamp Lurker', 'Analogy Hydra Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'fluffy_ogre', 'sparky_dragon'],
    subject: 'english',
    badge: 'Science Lab 🧪',
    bgStyle: 'bg-teal-50 border-teal-300 hover:border-teal-400',
  ...
  'g7-environment-pollution': {
    ...
    nodeColor: 'blue',
    emoji: '🌍',
    monsterNames: ['Dependent Slime', 'Independent Imp', 'Subordinating Sprite', 'Pit Golem', 'Clause Overlord Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'bramble_golem', 'bramble_golem'],
    subject: 'english',
    badge: 'Environment 🌍',
    bgStyle: 'bg-indigo-50 border-indigo-300 hover:border-indigo-400',
  ...
  'g7-media-communication': {
    ...
    nodeColor: 'green',
    emoji: '📱',
    monsterNames: ['Mummy Slime', 'Hieroglyph Imp', 'Scribe Sprite', 'Pyramid Golem', 'Pharaoh Lexicon Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'bramble_golem', 'sparky_dragon'],
    subject: 'english',
    badge: 'Media & Comm 📱',
    bgStyle: 'bg-teal-50 border-teal-300 hover:border-teal-400',
  ...
  'g8-history-archaeology': {
    ...
    nodeColor: 'blue',
    emoji: '🏺',
    monsterNames: ['Active Slime', 'Passive Sprite', 'Auxiliary Imp', 'Lava Golem', 'Volcano Overlord Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'bramble_golem', 'sparky_dragon'],
    subject: 'english',
    badge: 'History 🏺',
    bgStyle: 'bg-indigo-50 border-indigo-300 hover:border-indigo-400',
  ...
  'g8-law-justice': {
    ...
    nodeColor: 'green',
    emoji: '⚖️',
    monsterNames: ['Gerund Slime', 'Participle Imp', 'Infinitive Sprite', 'Void Wyvern', 'Galaxy Sage Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'sparky_dragon', 'sparky_dragon'],
    subject: 'english',
    badge: 'Law & Justice ⚖️',
    bgStyle: 'bg-teal-50 border-teal-300 hover:border-teal-400',
  ...
  'g8-psychology-behavior-g8': {
    ...
    nodeColor: 'blue',
    emoji: '🧠',
    monsterNames: ['Cognitive Slime', 'Motive Sprite', 'Behavioral Imp', 'Synapse Wyvern', 'Psych Master Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'sparky_dragon', 'sparky_dragon'],
    subject: 'english',
    badge: 'Psychology 🧠',
    bgStyle: 'bg-indigo-50 border-indigo-300 hover:border-indigo-400',
  ...
  'g8-astronomy-physics': {
    ...
    nodeColor: 'green',
    emoji: '🔭',
    monsterNames: ['Gravity Slime', 'Velocity Imp', 'Orbital Sprite', 'Cosmic Gargoyle', 'Newton Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'fluffy_ogre', 'sparky_dragon'],
    subject: 'english',
    badge: 'Astronomy 🔭',
    bgStyle: 'bg-teal-50 border-teal-300 hover:border-teal-400',
  ...
  'g8-global-economics': {
    ...
    nodeColor: 'orange',
    emoji: '📈',
    monsterNames: ['Market Slime', 'Tariff Imp', 'Inflation Sprite', 'Commerce Golem', 'Trade Master Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'bramble_golem', 'sparky_dragon'],
    subject: 'english',
  ...
  'g8-literary-analysis': {
    ...
    nodeColor: 'purple',
    emoji: '🖋️',
    monsterNames: ['Theme Slime', 'Motif Sprite', 'Symbol Imp', 'Plot Golem', 'Critic Overlord Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'bramble_golem', 'sparky_dragon'],
    subject: 'english',
  ...
  'g8-rhetoric-speech': {
    ...
    nodeColor: 'yellow',
    emoji: '🎙️',
    monsterNames: ['Orator Slime', 'Speech Imp', 'Delivery Sprite', 'Debate Golem', 'Rhetoric Sage Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'bramble_golem', 'sparky_dragon'],
    subject: 'english',
    badge: 'Rhetoric 🎙️',
    bgStyle: 'bg-amber-50 border-amber-300 hover:border-amber-400',
  ...
  'g9-literary-devices': {
    ...
    nodeColor: 'blue',
    emoji: '📖',
    monsterNames: ['Ethos Slime', 'Pathos Sprite', 'Logos Imp', 'Quagmire Lurker', 'Sophist Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'fluffy_ogre', 'fluffy_ogre'],
    subject: 'english',
  ...
  'g9-philosophy-ethics': {
    ...
    nodeColor: 'blue',
    emoji: '⚖️',
    monsterNames: ['Logic Slime', 'Proof Imp', 'Ethical Sprite', 'Socrates Golem', 'Reasoning Sage Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'bramble_golem', 'sparky_dragon'],
    subject: 'english',
    badge: 'Philosophy ⚖️',
    bgStyle: 'bg-indigo-50 border-indigo-300 hover:border-indigo-400',
  ...
  'g9-public-speaking': {
    ...
    nodeColor: 'green',
    emoji: '🎤',
    monsterNames: ['Vocal Slime', 'Tone Sprite', 'Stage Imp', 'Presentation Golem', 'Keynote King Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'bramble_golem', 'sparky_dragon'],
    subject: 'english',
  ...
  'g9-environmental-science': {
    ...
    nodeColor: 'orange',
    emoji: '🌿',
    monsterNames: ['Eco Slime', 'Biodiversity Imp', 'Sustain Sprite', 'Forest Golem', 'Ecosystem Lord Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'bramble_golem', 'sparky_dragon'],
    subject: 'english',
    badge: 'Eco Science 🌿',
    bgStyle: 'bg-pink-50 border-pink-300 hover:border-pink-400',
  ...
  'g9-world-history': {
    ...
    nodeColor: 'purple',
    emoji: '🌍',
    monsterNames: ['Treaty Slime', 'Pact Sprite', 'Alliance Imp', 'Dynasty Golem', 'Chronicle Emperor Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'bramble_golem', 'sparky_dragon'],
    subject: 'english',
    badge: 'World History 🌍',
    bgStyle: 'bg-purple-50 border-purple-300 hover:border-purple-400',
  ...
  'g9-sociology-culture': {
    ...
    nodeColor: 'yellow',
    emoji: '👥',
    monsterNames: ['Norm Slime', 'Ritual Sprite', 'Structure Imp', 'Society Golem', 'Culture Guardian Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'bramble_golem', 'sparky_dragon'],
    subject: 'english',
    badge: 'Sociology 👥',
    bgStyle: 'bg-amber-50 border-amber-300 hover:border-amber-400',
  ...
  'g10-philosophy-beliefs': {
    ...
    nodeColor: 'blue',
    emoji: '🧘',
    monsterNames: ['Alliteration Slime', 'Oxymoron Sprite', 'Irony Golem', 'Climax Wyvern', 'Poet Laureate Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'bramble_golem', 'sparky_dragon', 'sparky_dragon'],
    subject: 'english',
    badge: 'Philosophy 🧘',
    bgStyle: 'bg-indigo-50 border-indigo-300 hover:border-indigo-400',
  ...
  'g10-ethics-morality': {
    ...
    nodeColor: 'blue',
    emoji: '🕊️',
    monsterNames: ['Virtue Slime', 'Duty Sprite', 'Code Imp', 'Framework Golem', 'Ethicist Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'bramble_golem', 'sparky_dragon'],
    subject: 'english',
    badge: 'Ethics 🕊️',
    bgStyle: 'bg-indigo-50 border-indigo-300 hover:border-indigo-400',
  ...
  'g10-media-literacy': {
    ...
    nodeColor: 'green',
    emoji: '📰',
    monsterNames: ['Bias Slime', 'Censor Sprite', 'Source Imp', 'Broadcast Golem', 'Journalist Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'bramble_golem', 'sparky_dragon'],
    subject: 'english',
  ...
  'g10-scientific-vocabulary': {
    ...
    nodeColor: 'orange',
    emoji: '🔬',
    monsterNames: ['Variable Slime', 'Control Sprite', 'Hypothesis Imp', 'Lab Golem', 'Researcher Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'bramble_golem', 'sparky_dragon'],
    subject: 'english',
  ...
  'g10-microeconomics': {
    ...
    nodeColor: 'purple',
    emoji: '📊',
    monsterNames: ['Supply Slime', 'Demand Sprite', 'Price Imp', 'Market Golem', 'Economist Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'bramble_golem', 'sparky_dragon'],
    subject: 'english',
  ...
  'g10-advanced-composition': {
    ...
    nodeColor: 'yellow',
    emoji: '✒️',
    monsterNames: ['Thesis Slime', 'Citation Sprite', 'Outline Imp', 'Draft Golem', 'Academic Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'bramble_golem', 'sparky_dragon'],
    subject: 'english',
    badge: 'Composition ✒️',
    bgStyle: 'bg-amber-50 border-amber-300 hover:border-amber-400',
  ...
  'g11-economics-finance': {
    ...
    nodeColor: 'blue',
    emoji: '💰',
    monsterNames: ['Inversion Slime', 'Parallelism Imp', 'Structure Golem', 'Syntax Wyvern', 'Sea Mage Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'bramble_golem', 'sparky_dragon', 'sparky_dragon'],
    subject: 'english',
    badge: 'Economics 💰',
    bgStyle: 'bg-indigo-50 border-indigo-300 hover:border-indigo-400',
  ...
  'g11-critical-theory': {
    ...
    nodeColor: 'blue',
    emoji: '🧐',
    monsterNames: ['Paradigm Slime', 'Critique Sprite', 'Structural Imp', 'Deconstruction Golem', 'Theorist Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'bramble_golem', 'sparky_dragon'],
    subject: 'english',
  ...
  'g11-academic-verbs': {
    ...
    nodeColor: 'green',
    emoji: '✍️',
    monsterNames: ['Evaluate Slime', 'Synthesize Sprite', 'Substantiate Imp', 'Construct Golem', 'Scholar Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'bramble_golem', 'sparky_dragon'],
    subject: 'english',
  ...
  'g11-legal-terminology': {
    ...
    nodeColor: 'orange',
    emoji: '⚖️',
    monsterNames: ['Lawsuit Slime', 'Contract Sprite', 'Tort Imp', 'Protocol Golem', 'Attorney Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'bramble_golem', 'sparky_dragon'],
    subject: 'english',
    badge: 'Legal Terms ⚖️',
    bgStyle: 'bg-pink-50 border-pink-300 hover:border-pink-400',
  ...
  'g11-advanced-rhetoric': {
    ...
    nodeColor: 'purple',
    emoji: '🗣️',
    monsterNames: ['Logos Slime', 'Ethos Sprite', 'Pathos Imp', 'Persuasion Golem', 'Rhetorician Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'bramble_golem', 'sparky_dragon'],
    subject: 'english',
  ...
  'g11-international-relations': {
    ...
    nodeColor: 'yellow',
    emoji: '🌐',
    monsterNames: ['Sovereign Slime', 'Treaty Sprite', 'Alliance Imp', 'Diplomatic Golem', 'Ambassador Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'bramble_golem', 'sparky_dragon'],
    subject: 'english',
    badge: 'Int Relations 🌐',
    bgStyle: 'bg-amber-50 border-amber-300 hover:border-amber-400',
  ...
  'g12-scholarly-jargon': {
    ...
    nodeColor: 'blue',
    emoji: '🏛️',
    monsterNames: ['Inference Slime', 'Theme Sprite', 'Symbol Gargoyle', 'Library Guardian', 'Chief Archivist Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'fluffy_ogre', 'sparky_dragon', 'sparky_dragon'],
    subject: 'english',
  ...
  'g12-epistemology': {
    ...
    nodeColor: 'blue',
    emoji: '💭',
    monsterNames: ['Belief Slime', 'Truth Sprite', 'Knowledge Imp', 'Cognitive Golem', 'Philosopher Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'bramble_golem', 'sparky_dragon'],
    subject: 'english',
    badge: 'Epistemology 💭',
    bgStyle: 'bg-indigo-50 border-indigo-300 hover:border-indigo-400',
  ...
  'g12-postmodern-vocab': {
    ...
    nodeColor: 'green',
    emoji: '🎨',
    monsterNames: ['Abstract Slime', 'Deconstruction Sprite', 'Critique Imp', 'Irony Golem', 'Postmodernist Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'bramble_golem', 'sparky_dragon'],
    subject: 'english',
  ...
  'g12-research-methodologies': {
    ...
    nodeColor: 'orange',
    emoji: '📊',
    monsterNames: ['Qualitative Slime', 'Quantitative Sprite', 'Model Imp', 'Data Golem', 'Methodologist Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'bramble_golem', 'sparky_dragon'],
    subject: 'english',
  ...
  'g12-scientific-paradigms': {
    ...
    nodeColor: 'purple',
    emoji: '🧬',
    monsterNames: ['Paradigm Slime', 'Theory Sprite', 'Empirical Imp', 'Validation Golem', 'Academician Boss'],
    monsterIds: ['muddy_slime', 'muddy_slime', 'muddy_slime', 'bramble_golem', 'sparky_dragon'],
    subject: 'english',
